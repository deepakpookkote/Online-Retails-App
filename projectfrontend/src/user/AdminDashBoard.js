...
const AdminDashboard = () => {
    ...
    const adminRightSide = () => {
        return (
            <div className="card mb-4">
                ...
                <ul className="list-group">
                    <li className="list-group-item">
                        <span className="badge badge-success mr-2 capitalize">Name:</span> {name}
                    </li>
                    <li className="list-group-item">
    ...
    return (
        <Base title="AdminDashboard Page" description="Manage all your products here!" className="container bg-success p-4">
            <div className="row">
